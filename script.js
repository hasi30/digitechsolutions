...
const DIGITECH_IMAGES = {
  logo: "images/dlogo.jpeg",

  sanosFashion: {
    cover: "images/projects/sanos-fashion/cover.png",
    case1: "images/projects/sanos-fashion/01.png",
    case2: "images/projects/sanos-fashion/02.png",
    case3: "images/projects/sanos-fashion/03.png"
  },
  xyzConstruction: {
...
/* ---------------- RENDER: LOGO & CONTACT ---------------- */
document.getElementById("topLogo").src = DIGITECH_IMAGES.logo;
...
function renderCase(idx){
  ...
  const imgs = DIGITECH_IMAGES[p.key];
  document.getElementById("caseMainImg").src = imgs.case1;
  document.getElementById("caseMainImg").alt = p.name + " main case study image";
